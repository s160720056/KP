...
if(isset($_POST['temanObrolan'])){
    $temanObrolan = $_POST['temanObrolan'];
}else{
        
}
// echo"<script>alert('$temanObrolan,$username')</script>";
$output = '';
$hasil = array();
// Mencari Data teman obrolan
$cari = "SELECT * FROM users WHERE email = '$temanObrolan'";
...
while ( $data = mysqli_fetch_array($query) ){
        ...
        if ($penerima == $temanObrolan){
                $output .= '<div class="incoming_msg">
                      <div class="incoming_msg_img"> <img src="../assets/image/person.png" alt="sunil"> </div>
