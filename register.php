...
if(isset($_GET['status'])){
    if($_GET['status']=="error"){
        echo "<script>alert('Terjadi Error Mohon mengecek Kembali');window.location.href='register.php';</script>";
    }
    else if($_GET['status']=="success"){
        echo "<script>alert('Data inserted successfully');window.location.href='login.php';</script>";
    }
    else if($_GET['status']=='exist'){
        echo "<script>alert('Data Exist!');window.location.href='register.php';</script>";
    }
}
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="action.php">
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" name="noHP" type="phone" placeholder="Confirm password" />
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" name="inputPassword" type="password" placeholder="Create a password" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input name="register" type="submit"class="btn btn-primary btn-block" href="action.php" value="Create Account"></div>
                                            </div>
                                        </form>
                                    </div>
